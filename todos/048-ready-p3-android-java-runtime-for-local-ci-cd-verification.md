...
- [ ] A Java 17 runtime is available for local Android Gradle verification, or
      the lack of local Java is documented as an intentional limitation
- [ ] Android CI/CD developer docs state the required Java/Gradle verification
      commands
- [ ] The `JsonValueConverterTest` command from `todos/033` has been re-run
      successfully locally or verified in CI
- [ ] Full Android tests (`./gradlew test`) have been run locally or their CI
