...
// packages/web-renderer/src/cli.ts
...
if (command === "serve") {
  ...
  const port = Number(args.indexOf("--port") >= 0 ? args[args.indexOf("--port") + 1] : 3e3);
  const html = (jsonPath) => `<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="utf-8" />
...
<body>
  <div id="app"></div>
  <script type="module">
    import { JasonetteRenderer } from '/__jasonette__/jasonette.js';
