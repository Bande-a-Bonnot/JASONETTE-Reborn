...
function matrixBackground(id: string) {
  ...
  const spies: any[] = [];
  const inherited = (values: Record<string, unknown>, own: Record<string, unknown>) => {
    const prototype: any = {};
  ...
  switch (id) {
    ...
    case "inherited-only source fields": return {
    ...
    case "inherited text with own URL": return {
      background: inherited(
        { text: "<p>bad</p>" },
        { type: "html", url: "https://example.com/own-background.html" },
      ),
      spies,
    };
    case "inherited URL with own text": return {
      background: inherited(
        { url: "https://example.com/bad" },
        { type: "html", text: "<p>own background</p>" },
      ),
      spies,
    };
    case "inherited CSS with own text": return {
      background: inherited(
        { css: "bad{}" },
        { type: "html", text: "<p>own cssless</p>" },
      ),
      spies,
    };
    case "missing type": delete background.type; background.text = "<p>bad</p>"; break;
    case "inherited HTML type": return {
      background: inherited({ type: "html" }, { text: "<p>bad</p>" }),
      spies,
    };
