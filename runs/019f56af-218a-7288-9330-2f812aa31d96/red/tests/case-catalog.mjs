...
const productionPipelineSetups = {
  ...
  header: 'body.header.items owns location-marked inline HTML, URL HTML, and label components while body.sections is empty',
  footer: 'body.footer.items owns location-marked inline HTML, URL HTML, and label components while body.sections is empty',
  section: 'body.sections[0].items directly owns location-marked inline HTML, URL HTML, and label components',
  layout: 'body.sections[0].items[0] is a vertical layout whose items own location-marked inline HTML, URL HTML, and label components',
  layer: 'body.layers[0] is a vertical layer whose items own location-marked inline HTML, URL HTML, and label components, separate from a foreground section',
  ...
  "nested-array": 'body.sections[0].items has three array levels around location-marked inline HTML, URL HTML, and label components',
...
const productionPipelineExpected = {
  ...
  "action-options": 'clicking the exact rendered controls run-action-options-first and run-action-options-second stores options.actionOptionsProbe with type="html", literal text {{$jason.secret}}, and style heights 31 then 62',
  "action-payload": 'clicking the exact rendered controls run-action-payload-first and run-action-payload-second stores options.actionPayloadProbe.payload with type="html", literal text {{$jason.secret}}, and style heights 31 then 62',
};
