...
| `packages/template-engine/src/evaluator.ts` | Preserve generic expression flattening and collision precedence; support body key interpolation with per-frame getter ordering. |
