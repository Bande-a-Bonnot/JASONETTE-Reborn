...
- iOS: 554 tests, 0 failures (verified 2026-06-05 after vision unsupported fallback fix; `swift build` succeeded); generic iOS Simulator `xcodebuild` Debug build succeeded 2026-06-05; direct-entry iPhone 17 Pro simulator QA for action screens completed 2026-06-03 with findings in `docs/qa/2026-06-03-ios-action-screen-qa.md`
