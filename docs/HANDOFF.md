...
- iOS: 408 tests, 0 failures (verified 2026-04-29 after footer-tab relative URL resolution Codex follow-up; tab navigation rewrite merged to `main` via PR #20 squash `11b9fca`)
