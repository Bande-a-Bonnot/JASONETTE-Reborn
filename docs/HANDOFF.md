...
- iOS: 542 tests, 0 failures (verified 2026-06-02 after `$media.play` support; `swift build` succeeded); generic iOS Simulator `xcodebuild` verified 2026-06-01; direct-entry iPhone 17 Pro simulator QA for network Eliza and textarea fixtures succeeded 2026-05-31, though `agent-device` attach/snapshot timed out
